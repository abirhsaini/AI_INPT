...
def navigate_2eme_interface():
    ...
    if (interface1.line.text()=="")   :
        ...
        !python C:/Users/pc/Desktop/inpt/pfa/AI_INPT2/AI_INPT/detect.py --weights C:/Users/pc/Desktop/inpt/pfa/AI_INPT2/AI_INPT/best.pt --source $source  --name $name --save-txt  --save-conf --conf 0.40
        widget.setCurrentIndex(widget.currentIndex()+1)
